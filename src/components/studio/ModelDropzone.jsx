...
import { UploadCloud, X, Cuboid } from "lucide-react";
import { cn } from "@/lib/utils";
import { useT } from "@/hooks/useI18n";

const MAX_MB = 50;
const ACCEPT = ".glb,.gltf,.obj,.fbx,.stl";
const EXT_RE = /\.(glb|gltf|obj|fbx|stl)$/i;

/** 3D model dropzone. Calls onFile(File | null). */
export default function ModelDropzone({ file, onFile, error }) {
  const t = useT();
