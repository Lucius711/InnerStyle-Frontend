...
Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'Ready' }) resolved to 2 elements:
    ...
    2) <div tabindex="0" role="button" class="group glass relative cursor-pointer overflow-hidden rounded-2xl text-left transition-shadow hover:shadow-glow">…</div> aka getByRole('button', { name: 'Ready Options Refine 2s ago' })
